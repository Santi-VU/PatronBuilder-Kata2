using PatronBuilder_Kata2.Models;
using System;
...
namespace PatronBuilder_Kata2
{
	...
	public static class SampleTests
	{
		...
		{
			var actual = new CoffeeBuilder().SetAntoccinoCoffee().WithMilk(0.5).Build();
		...
		{
			var actual = new CoffeeBuilder().SetCubanoCoffee().WithSugar("Brown").Build();
